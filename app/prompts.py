...
TRANSITION_MESSAGES = {
    ...
    "현실 탐색": "여기까지 이야기를 들으니, 조금 더 깊이 생각해볼 부분이 있을 것 같은데요.",
    "목표 설정": "지금까지 나눈 이야기를 돌아봤을 때, 어떤 변화를 원하시나요?",
    "대안 탐색": "원하시는 방향이 보이는 것 같아요. 어떤 방법들을 생각해보셨나요?",
    "실행 계획": "여러 방법들을 이야기해주셨는데요. 구체적으로 어떻게 시작하면 좋을까요?",
    "정리 및 마무리": "오늘 우리가 나눈 대화를 돌아보면 어떤 생각이 드시나요?"
}
